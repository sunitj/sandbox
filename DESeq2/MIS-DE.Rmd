...
```{r geneFilter, }
library("genefilter")
topVarGenes <- head(order(-rowVars(assay(ddsHTSeq))),20)
```
...
sidecols <- c("grey","dodgerblue")[ ddsHTSeq$condition ]
mat <- assay(ddsHTSeq)[ topVarGenes, ]
mat <- mat - rowMeans(mat)

mat <- assay(ddsHTSeq)[ topVarGenes, ]
mat <- mat - rowMeans(mat)
df <- as.data.frame(colData(ddsHTSeq))
