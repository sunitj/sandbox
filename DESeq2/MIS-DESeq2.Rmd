...
#day.counts=countData[, c("Night_4","Day_2","Day_3")]
...
#day.counts.ordered$Rank = seq(length(day.counts.ordered$Name))
...
#night.counts=countData[, c("Day_1","Night_5","Night_6")]
