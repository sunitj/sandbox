...
## Reads per Sample
```{r readsPerSample}
apply(counts(ddsHTSeq.all), 2, sum)
```
...
```{r write_counts}
write.table(combined.anno, file="data/combined_raw_counts.tsv",sep="\t", quote=FALSE, row.names = FALSE);
```
...
write.table(as.data.frame(resOrdered.top125), sep="\t",file="data/results.tsv", quote = FALSE, row.names =FALSE)
```
