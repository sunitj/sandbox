...
$params{db} = "pubmed";
$params{tool} = "ebot";
$params{term} = "metagenomic OR metagenomics OR metagenome OR metatranscriptome OR metatranscriptomic OR metatranscriptomics OR metaproteome OR metaproteomic OR metaproteomics";
%params = esearch(%params);

$params{retmode} = "html";
$params{outfile} = "pubmed_allTime_search.html";
$params{batch} = -1;
efetch_batch(%params);
