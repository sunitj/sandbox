...
all.PIs=contacts %>% filter(Status == "Ongoing")
...
this.billing.cycle=left_join(all.PIs,last.billed, by="Abb") %>% select(Abb, PI, Invoice.Num, Date, Type, Period.From, Period.To, Shortcode, Rate)
...
```{r generate_invoice}
this.billing.cycle=this.billing.cycle[c("Abb", "PI", "Invoice.Num", "Date", "Type", "Period.From", "Period.To", "Shortcode", "Hours", "Rate", "Total")]
